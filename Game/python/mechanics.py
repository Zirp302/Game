...
class Animation:
    ...
    def __init__(self, x=0, y=0, img_name=''): # Добавить автоматизацию
        imgs_left = (
            pyglet.image.load(str(Animation.file_game)+"/img/left_f0.png"), 
            pyglet.image.load(str(Animation.file_game)+"/img/left_f1.png")
            )

        imgs_right = (
            pyglet.image.load(str(Animation.file_game)+"/img/right_f0.png"), 
            pyglet.image.load(str(Animation.file_game)+"/img/right_f1.png")
            )
